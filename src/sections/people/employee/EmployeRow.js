  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell>
          {emp_mst_dateofhire &&  emp_mst_dateofhire.date?format(new Date(emp_mst_dateofhire.date), "yyyy-MM-dd"):""}
        </TableCell>
  
        <TableCell>{emp_mst_sex === "M" ?"Male":emp_mst_sex === "F"?"Female":""}</TableCell>

        <TableCell>
          {emp_mst_date_of_birth &&  emp_mst_date_of_birth.date?format(new Date(emp_mst_date_of_birth.date), "yyyy-MM-dd"):""}
        </TableCell>
        ...
        <TableCell>
          {emp_mst_create_date &&  emp_mst_create_date.date?format(new Date(emp_mst_create_date.date), "yyyy-MM-dd"):""}
        </TableCell>
       
    
        <TableCell>{audit_user}</TableCell>
        <TableCell>{audit_date &&  audit_date.date?format(new Date(audit_date.date), "yyyy-MM-dd"):""}</TableCell>
        ...
        <TableCell>
         {emp_det_datetime1 &&  emp_det_datetime1.date?format(new Date(emp_det_datetime1.date), "yyyy-MM-dd"):""}
        </TableCell>
        <TableCell>
          {emp_det_datetime2 &&  emp_det_datetime2.date?format(new Date(emp_det_datetime2.date), "yyyy-MM-dd"):""}
        </TableCell>
        <TableCell>
          {emp_det_datetime3 &&  emp_det_datetime3.date?format(new Date(emp_det_datetime3.date), "yyyy-MM-dd"):""}
        </TableCell>
        <TableCell>
          {emp_det_datetime4 &&  emp_det_datetime4.date?format(new Date(emp_det_datetime4.date), "yyyy-MM-dd"):""}
        </TableCell>
        <TableCell>
          {emp_det_datetime5 &&  emp_det_datetime5.date?format(new Date(emp_det_datetime5.date), "yyyy-MM-dd"):""}
        </TableCell>
        <TableCell>
          {emp_det_datetime6 &&  emp_det_datetime6.date?format(new Date(emp_det_datetime6.date), "yyyy-MM-dd"):""}
        </TableCell>
        <TableCell>
          {emp_det_datetime7 &&  emp_det_datetime7.date?format(new Date(emp_det_datetime7.date), "yyyy-MM-dd"):""}
        </TableCell>
        <TableCell>
          {emp_det_datetime8 &&  emp_det_datetime8.date?format(new Date(emp_det_datetime8.date), "yyyy-MM-dd"):""}
        </TableCell>
        <TableCell>
          {emp_det_datetime9 &&  emp_det_datetime9.date?format(new Date(emp_det_datetime9.date), "yyyy-MM-dd"):""}
        </TableCell>
        <TableCell>
          {emp_det_datetime10 &&  emp_det_datetime10.date?format(new Date(emp_det_datetime10.date), "yyyy-MM-dd"):""}
        </TableCell>
