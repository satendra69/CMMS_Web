...
const MaintenceSection = ({ onRowClick, data,setData,MaintenceResult,setMaintenceResult,RowIDProp,state }) => {
...
Delete
  ...
  <TableCell >
  {item.emp_ls1_supervisor_id}
  </TableCell>
  <TableCell>
  {item.emp_ls1_pay_rate}
  </TableCell>
  <TableCell >
        {item.emp_ls1_charge_rate}
  </TableCell>
